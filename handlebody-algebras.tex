...
In this paper we consider (three dimensional) handlebodies of genus $g$. The two cases mentioned 
...
We expect these handlebody diagram 
...
assuming that \fullref{section:tlblob}, in which we
construct handlebody Temperley--Lieb and blob algebras, has been read. So 
...
In particular, algebras are $\KK$-algebras. We 
...
$(\bbvar_{g,\dpar})^{n}$. Since there are $(2n)!!$ corresponding 
