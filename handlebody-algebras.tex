...
these diagrams algebras get replaced by their (extended) affine versions, 
...
in this paper is linear over $\KK$. We write $\K$ if we assume that $\KK$ is a field, which is needed for classification results.
