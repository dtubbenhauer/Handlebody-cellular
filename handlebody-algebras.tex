...
of usual isotopies of tangles with $g+n$ strands 
...
$\cpar=(\cvar_{\gamma})_{\gamma}\in\KK$, one for each $\setstuff{F}_{g}$-colored circle $\gamma$, up to conjugacy of words.
...
we will denote these by $b_{u,i}$ to distinguish them. 
